...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { content: @notice.content, tv_show_id: @notice.tv_show_id, user_id: @notice.user_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { content: @notice.content, tv_show_id: @notice.tv_show_id, user_id: @notice.user_id } }
