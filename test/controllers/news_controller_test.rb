...
class NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news" do
    assert_difference('New.count') do
      post news_url, params: { news: { content: @news.content, tv_show_id: @news.tv_show_id, user_id: @news.user_id } }
    end
  ...
  test "should update news" do
    patch news_url(@news), params: { news: { content: @news.content, tv_show_id: @news.tv_show_id, user_id: @news.user_id } }
